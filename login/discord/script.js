...
window.onload = async function () {
  ...
  if (!fragment.get('access_token') && !fragment.get('logout')) {
    ...
    await sleep(1500)
    window.location = 'https://discord.com/api/oauth2/authorize?client_id=1122989140594655282&redirect_uri=http%3A%2F%2F127.0.0.1%3A5500%2Flogin%2Fdiscord%2F&response_type=token&scope=identify%20email%20guilds'
  } else {
    try {
